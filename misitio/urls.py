...
from django.contrib.auth.views import LoginView, LogoutView, TemplateView, PasswordResetView, PasswordResetDoneView, PasswordResetConfirmView, PasswordResetCompleteView
...
urlpatterns = [
    ...
    path('reset/password_reset', PasswordResetView.as_view(template_name='recuperacion/password_reset_forms.html', email_template_name="recuperacion/password_reset_email.html"), name = 'password_reset'),
